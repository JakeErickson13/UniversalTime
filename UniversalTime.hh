...
public:
  ...
  UniversalTime( const UInt_t days_, const UInt_t seconds_, const UInt_t nanoSeconds_ );

  /// Get the days
  ///
  /// @return days
  UInt_t GetDays() const { return days; }

  /// Get the seconds
  ///
  /// @return seconds
  UInt_t GetSeconds() const { return seconds; }
...
protected:
  ...
  UInt_t days; ///< Universal time i.e. relative to the world (days since SNO+ day0)
  UInt_t seconds; ///< Universal time i.e. relative to the world (secs)
  Double_t nanoSeconds; ///< Universal time i.e. relative to the world (nsecs)
};

inline
UniversalTime::UniversalTime( const UInt_t days_, const UInt_t seconds_, const UInt_t nanoSeconds_ )
